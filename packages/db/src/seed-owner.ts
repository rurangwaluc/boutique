...
const ownerEmail = process.env.OWNER_EMAIL || 'owner@laelegant.local';
const ownerPassword = process.env.OWNER_PASSWORD || 'Owner@12345';
const ownerName = process.env.OWNER_NAME || 'La Elegant Owner';
const businessName = process.env.BUSINESS_NAME || 'La Elegant Boutique';

const employeeEmail = process.env.EMPLOYEE_EMAIL;
const employeePassword = process.env.EMPLOYEE_PASSWORD || 'Employee@12345';
const employeeName = process.env.EMPLOYEE_NAME || 'La Elegant Employee';
