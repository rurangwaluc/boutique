  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <Link href="/" className={styles.brand} aria-label="La Elegant Boutique home">
          <span className={styles.logo}>LE</span>
          <span>
            <span className={styles.brandTop}>La Elegant</span>
      ...
      <section className={styles.hero}>
        ...
        <h1>Run La Elegant Boutique with clear sales, stock, and money records.</h1>
      ...
      <section className={styles.visit}>
        ...
        <div className={styles.contactPanel}>
          ...
          <strong>For La Elegant Boutique staff only</strong>
          <p>
      ...
      <footer className={styles.footer}>
        <p>© {year} La Elegant Boutique. All rights reserved.</p>
        <p>
          Developed by{' '}
